              ...
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4">
                <div className="bg-black/70 backdrop-blur-md rounded-lg p-2.5 sm:p-3 shadow-xl border border-white/20">
                  <p className="text-xs sm:text-sm font-bold text-white leading-snug">
                    "Finally, something my toddler chooses over the iPad."
                  </p>
              ...
              <div className="space-y-2.5 text-sm sm:text-base">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-gray-800 font-medium">
                    Your toddler asks for the iPad before saying "good morning"
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-600 font-black mt-0.5 text-base flex-shrink-0">
                  ...
                  <p className="text-gray-800 font-medium">
                    45-minute tantrums when screen time ends
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-600 font-black mt-0.5 text-base flex-shrink-0">
                  ...
                  <p className="text-gray-800 font-medium">
                    Every toy sits untouched "I'm bored" means "give me screens"
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-600 font-black mt-0.5 text-base flex-shrink-0">
                  ...
                  <p className="text-gray-800 font-medium">
                    You use screens as a babysitter just to survive the day
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-5 sm:p-7 border-2 border-red-200 shadow-lg">
              <div className="space-y-4">
                ...
                <p className="text-sm sm:text-base text-gray-800 leading-relaxed text-center font-medium">
                  My 3-year-old was <b>glued to YouTube</b>. Every attempt to
                  take it away ended in <b>chaos</b>. I needed something{" "}
                ...
                <p className="text-sm sm:text-base text-gray-800 leading-relaxed text-center font-medium">
                  These workbooks became my secret weapon. Simple, engaging,
                  screen-free.
                </p>
                ...
                <div className="bg-green-50 border-2 border-green-300 rounded-lg p-4">
                  <p className="font-black text-green-900 text-lg sm:text-xl text-center">
                    2 weeks later, she chose the workbooks over the iPad.
                  </p>
                </div>
                ...
                <div className="pt-3 border-t border-red-200">
                  <p className="text-xs sm:text-sm text-gray-700 italic text-center font-medium">
                    These workbooks gave me something real to replace screen
                    time with.
                  </p>
                </div>
              </div>
