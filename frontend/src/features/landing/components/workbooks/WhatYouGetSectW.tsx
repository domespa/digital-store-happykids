    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
                ...
                {chapter.highlights && chapter.highlights.length > 0 && (
                  <div className="mt-4 pl-12 sm:pl-16 space-y-2">
                    <p className="text-xs font-bold text-blue-600 uppercase tracking-wide mb-2">
                      {isWorkbooks ? "Included:" : "What You'll Get:"}
                    </p>
        ...
        {features.bonuses && features.bonuses.length > 0 && (
          <div className="bg-gradient-to-br from-green-600 to-emerald-700 rounded-xl p-6 sm:p-8 text-white shadow-xl">
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-2 leading-tight">
                {isWorkbooks
                  ? "Plus, Free Parent Resources"
                  : "Plus, You Get These Essential Tools"}
              </h3>
              <p className="text-sm sm:text-base text-white/90">
                {/* DINAMICO */}
                Total Value: {isWorkbooks ? "€" : "$"}
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-10 lg:mt-12">
          {[
            ...
            {
              Icon: Smartphone,
              title: isWorkbooks ? "Print Unlimited" : "Any Device",
              desc: isWorkbooks
                ? "Print for all your kids, forever"
                : "Read on phone, tablet, or print",
