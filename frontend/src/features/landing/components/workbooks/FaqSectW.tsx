...
export default function FaqSect() {
  ...
  const supportEmail = isWorkbooks
    ? "support@h4ppykids.com"
    : "support@screendetox.com";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-sm text-gray-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">
                  {isWorkbooks ? "Print Unlimited" : "No Risk Guarantee"}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-base text-gray-600 italic">
            {isWorkbooks
              ? "Don't wait another day. Every hour on screens is an hour they're not developing the skills that matter."
              : "Don't let uncertainty keep you stuck. Every day you wait, the addiction gets deeper."}
          </p>
        </div>
      </div>
    </section>
